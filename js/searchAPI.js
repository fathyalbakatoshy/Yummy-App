...
export class Search {
  constructor() {
    ...
    document.querySelector("#searchByName").addEventListener("input", (e) => this.searchByName(e.target.value))
    document.querySelector("#searchByLetter").addEventListener("input", (e) => this.searchByLetter(e.target.value))
    this.ui = new UI()
  }
